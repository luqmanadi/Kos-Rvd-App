...
import com.kosrvd.app.feature.management.presentation.designsystem.utils.toFormattedIndonesianDate
...
import com.kosrvd.app.feature.management.presentation.ui.models.toListKeluhanUi
...
class GetListKeluhanUseCase @Inject constructor(
    ...
    operator fun invoke(typeKeluhan: TypeKeluhan): Flow<Result<List<KeluhanGroupUi>, DataError>> = flow {
