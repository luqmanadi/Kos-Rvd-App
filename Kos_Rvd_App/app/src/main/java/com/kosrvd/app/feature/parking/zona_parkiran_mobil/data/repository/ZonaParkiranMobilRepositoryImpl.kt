package com.kosrvd.app.feature.parking.zona_parkiran_mobil.data.repository
...
import com.kosrvd.app.feature.parking.zona_parkiran_mobil.data.mappers.toZonaParkiran
import com.kosrvd.app.feature.parking.zona_parkiran_mobil.data.mappers.toZonaParkiranList
    ...
    override suspend fun getZonaParkiranMobilById(idZonaParkir: String): Result<ZonaParkiran, DataError> {
        return safeCall {
            db.collection(Constant.ZONA_PARKIRAN_COLLECTION)
                ...
                .get()
                .await()
                .toObject<ZonaParkiranDto>()
                ?: throw Exception(ErrorMessages.ZONA_PARKIRAN_MOBIL_NOT_FOUND)
