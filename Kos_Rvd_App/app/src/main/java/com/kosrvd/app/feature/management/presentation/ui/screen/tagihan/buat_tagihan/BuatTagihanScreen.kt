...
import com.kosrvd.app.feature.management.presentation.ui.screen.tagihan.component.AddDiskonCard
import com.kosrvd.app.feature.management.presentation.ui.screen.tagihan.component.DateRangePickerModalPeriodTagihan
import com.kosrvd.app.feature.management.presentation.ui.screen.tagihan.component.InfoDetailBuatTagihanCard
            ...
            Column(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                    ...
                    OutlinedTextField(
                        ...
                        supportingText = {
                            if (buatTagihanUiState.isSelectedPeriodError) {
                                Text(text = buatTagihanUiState.selectedPeriodError?.asString() ?: "")
                            }
                        },
