...
import com.kosrvd.app.presentation.main.MainViewModel
...
import com.kosrvd.app.presentation.app_shell.MainScreen
import com.kosrvd.app.feature.complaint.presentation.buat_laporan_keluhan.BuatLaporanKeluhanEvents
import com.kosrvd.app.feature.complaint.presentation.buat_laporan_keluhan.BuatLaporanKeluhanScreen
import com.kosrvd.app.feature.complaint.presentation.buat_laporan_keluhan.BuatLaporanKeluhanViewModel
import com.kosrvd.app.feature.complaint.presentation.detail_keluhan.DetailKeluhanEvents
import com.kosrvd.app.feature.complaint.presentation.detail_keluhan.DetailKeluhanScreen
import com.kosrvd.app.feature.complaint.presentation.detail_keluhan.DetailKeluhanViewModel
import com.kosrvd.app.feature.notification.presentation.list_notification.NotificationEvents
import com.kosrvd.app.feature.notification.presentation.list_notification.NotificationScreen
import com.kosrvd.app.feature.notification.presentation.list_notification.NotificationViewModel
import com.kosrvd.app.core.presentation.preview_image.PreviewImageScreen
import com.kosrvd.app.feature.profile.presentation.detail_profile.DetailProfileEvents
import com.kosrvd.app.feature.profile.presentation.detail_profile.DetailProfileScreen
import com.kosrvd.app.feature.profile.presentation.detail_profile.DetailProfileViewModel
import com.kosrvd.app.feature.profile.presentation.detail_sewa_kamar.DetailSewaKamarEvents
import com.kosrvd.app.feature.profile.presentation.detail_sewa_kamar.DetailSewaKamarScreen
import com.kosrvd.app.feature.profile.presentation.detail_sewa_kamar.DetailSewaKamarViewModel
import com.kosrvd.app.feature.profile.presentation.edit_data_profile.EditDataProfileEvents
import com.kosrvd.app.feature.profile.presentation.edit_data_profile.EditDataProfileScreen
import com.kosrvd.app.feature.profile.presentation.edit_data_profile.EditDataProfileViewModel
import com.kosrvd.app.feature.profile.presentation.edit_photo_profile.EditPhotoProfileEvents
import com.kosrvd.app.feature.profile.presentation.edit_photo_profile.EditPhotoProfileScreen
import com.kosrvd.app.feature.profile.presentation.edit_photo_profile.EditPhotoProfileViewModel
import com.kosrvd.app.feature.profile.presentation.reset_password.ResetPasswordEvents
import com.kosrvd.app.feature.profile.presentation.reset_password.ResetPasswordScreen
import com.kosrvd.app.feature.profile.presentation.reset_password.ResetPasswordViewModel
import com.kosrvd.app.core.presentation.result.ResultScreen
import com.kosrvd.app.feature.billing.presentation.buat_tagihan.BuatTagihanEvents
import com.kosrvd.app.feature.billing.presentation.buat_tagihan.BuatTagihanScreen
import com.kosrvd.app.feature.billing.presentation.buat_tagihan.BuatTagihanViewModel
import com.kosrvd.app.feature.billing.presentation.detail_tagihan.DetailTagihanEvents
import com.kosrvd.app.feature.billing.presentation.detail_tagihan.DetailTagihanScreen
import com.kosrvd.app.feature.billing.presentation.detail_tagihan.DetailTagihanViewModel
import com.kosrvd.app.feature.billing.presentation.pengaturan_tagihan.PengaturanTagihanEvents
import com.kosrvd.app.feature.billing.presentation.pengaturan_tagihan.PengaturanTagihanScreen
import com.kosrvd.app.feature.billing.presentation.pengaturan_tagihan.PengaturanTagihanViewModel
