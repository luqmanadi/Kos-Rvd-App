package com.kosrvd.app.feature.parking.parkir_harian_mobil.data.repository
...
import com.kosrvd.app.core.presentation.utils.getNowEndOfDay
import com.kosrvd.app.feature.parking.parkir_harian_mobil.data.mappers.toListOfParkirHarianMobil
import com.kosrvd.app.feature.parking.parkir_harian_mobil.data.mappers.toParkirHarianMobil
    ...
    override suspend fun getParkirHarianMobilById(idParkirHarianMobil: String): Result<ParkirHarianMobil, DataError> {
        return safeCall {
            db.collection(Constant.PARKIR_HARIAN_MOBIL_COLLECTION)
                ...
                .get()
                .await()
                .toObject<ParkirHarianMobilDto>()
                ?: throw Exception(ErrorMessages.PARKIR_HARIAN_MOBIL_NOT_FOUND)
