...
import com.kosrvd.app.feature.management.data.FileManager
import com.kosrvd.app.feature.management.data.mappers.toResultLaporanKeluhan
import com.kosrvd.app.feature.management.domain.usecase.BuatLaporanKeluhanUseCase
...
sealed interface BuatLaporanKeluhanActions {
    ...
    data class TrySaveCompressImage(val context: Context): BuatLaporanKeluhanActions
...
class BuatLaporanKeluhanViewModel @Inject constructor(
    ...
    fun onActions(actions: BuatLaporanKeluhanActions) {
        when (actions) {
            ...
            is BuatLaporanKeluhanActions.TrySaveCompressImage -> trySaveImage(actions.context)
    ...
    private fun trySaveImage(context: Context){
        viewModelScope.launch {
            _state.update {
                it.copy(
            ...
            if (imageUri == Uri.EMPTY) {
                ...
                _events.send(BuatLaporanKeluhanEvents.ShowSnackBarError("Gambar Uri Kosong"))
                return@launch
            }
            ...
            if (compressedImage!= null){
                ...
                _events.send(BuatLaporanKeluhanEvents.ShowToast("Berhasil menyimpan compress gambar"))
            } else {
                _state.update {
                    it.copy(
                        isButtonLoading = false,
                ...
                _events.send(BuatLaporanKeluhanEvents.ShowSnackBarError("Gagal menyimpan compress gambar"))
            }
