...
import com.kosrvd.app.core.presentation.utils.INDONESIAN_LOCALE
import com.kosrvd.app.core.presentation.utils.UTC_ZONE_ID
                        ...
                        if (startMillis != null && endMillis != null && !isRangeTooLong) {
                            val periodString =
                                "${startMillis.toDayMonthShortAndYear(UTC_ZONE_ID)} - ${
                                    endMillis.toDayMonthShortAndYear(UTC_ZONE_ID)
                                }"
            ...
            DateRangePicker(
                ...
                title = {
                    Column(
                        ...
                        val warningText =
                            if (startMillis != null && isRangeTooLong && maxEndDateMillis != null) {
