package com.kosrvd.app.feature.parking.zona_parkiran_mobil.domain.repository
...
interface ZonaParkiranMobilRepository {
    ...
    suspend fun getZonaParkirByZoneName(zoneName: String): Result<List<ZonaParkiran>, DataError>
}